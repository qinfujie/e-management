...
//     * @return String
//     */
//    private String addData(Object object, String index, String id) throws IOException {
//        if (null == id) {
//            return addData(object, index);
//        }
//        if (this.existsById(index, id)) {
...
//     * @return String
//     */
//    private String addData(Object object, String index) throws IOException {
...
//     * @return String
//     */
//    private String updateDataByIdNoRealTime(Object object, String index, String id) throws IOException {
//        //更新请求
//        UpdateRequest updateRequest = new UpdateRequest(index, id);
//
//        //保证数据实时更新
...
//     * @return boolean
//     */
//    private boolean existsById(String index, String id) throws IOException {
//        GetRequest request = new GetRequest(index, id);
//        //不获取返回的_source的上下文
...
//     *
//     * @param searchResponse  查询请求
//     * @param highlightField 高版本值
//     */
